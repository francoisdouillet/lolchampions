    ...
    return (
        <div className="champions">
            ...
            {matchupsSets.map((matchup, index) => (
                <div>
                    <div>
                        {matchup.matchup ? <div>{matchup.matchup}</div> : <h2>Choisis ton champion</h2>}
                        <Button>
                            <DeleteIcon />
                        </Button>
                    </div>
                    {matchup.matchup ? (
                        <div className="champions__matchups">
                            <img alt={matchup.matchup} src={`https://ddragon.leagueoflegends.com/cdn/13.1.1/img/champion/${matchup.matchup}.png`} />
                            <Select
                            ...
                            <textarea placeholder="Notes" value={matchupsSets[index].notes} onChange={(e) => addNotesToSet(e.target.value, index)} />
                        </div>) :
